...
class Img_DataSet(Dataset):
    def __init__(self, data_path, label_path, args):
        ...
        # Read a data file and normalize, resize.
    ...
    def padding_img(self, img, size, stride):
        ...
        # print("Print the shape of img_s, img_h, img_w，", img_s, img_h, img_w)
        ...
        # print("The value of s，img_h，img_w", s, img_h, img_w)
