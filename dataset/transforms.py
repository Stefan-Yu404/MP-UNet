...
class Center_Crop:
    def __init__(self, base, max_size):
        self.base = base  # base takes 16 by default, because it is 1 after 4 downsampling.
        self.max_size = max_size 
        if self.max_size % self.base:
            # max_size is to limit the maximum number of sampling slices to prevent memory overflow, and it should also be a multiple of 16.
